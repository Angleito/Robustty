...
api_calls_total = Counter(
    "rumble_api_calls_total", "Total number of API calls made", ["endpoint", "status"]
)
...
cache_hits_total = Counter(
    "rumble_cache_hits_total", "Total number of cache hits", ["cache_type"]
)

# Cache misses counter - tracks cache misses by cache type
cache_misses_total = Counter(
    "rumble_cache_misses_total", "Total number of cache misses", ["cache_type"]
)

# Rate limit counter - tracks rate limit encounters
rate_limits_total = Counter(
    "rumble_rate_limits_total", "Total number of rate limit encounters", []
)

# Error counter - tracks errors by type
errors_total = Counter("rumble_errors_total", "Total number of errors", ["error_type"])

# Current queue size gauge
queue_size = Gauge("rumble_queue_size", "Current size of the music queue")

# Active connections gauge
active_connections = Gauge(
    "rumble_active_connections", "Number of active voice connections"
)
